...
We complement our method with the exact kinetic-balance condition for 16-component explicitly 
correlated functions in order to ensure variational stability and avoid the variational collapse. 
The two fermions are treated explicitly in the simple laboratory fixed cartesian coordinates 
and we avoid having to transform the Dirac Hamiltonian to internal coordinates.
